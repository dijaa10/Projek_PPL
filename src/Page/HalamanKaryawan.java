 ...
 */
public class HalamanKaryawan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Halaman Karyawan");
        ...
        cr.setText("Cari Berdasarkan Kode");
    ...
    private void crKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_crKeyPressed
        ...
        if (evt.getKeyCode()==KeyEvent.VK_ENTER) {
            try {
            Statement statement = (Statement) config.getConnection().createStatement();
            ResultSet res = statement.executeQuery("SELECT * FROM karyawan WHERE id_karyawan LIKE '%" + 
                    cr.getText() + "%' OR nama_karyawan LIKE '%" + cr.getText() + "%' OR username LIKE '%" + 
                       cr.getText() + "%' OR level LIKE '%"  + cr.getText() + "%';");
            DefaultTableModel tbl = new DefaultTableModel();
            cr.setText("");
            tbl.addColumn("Kode Karyawan");
            tbl.addColumn("Nama Karyawan");
